...
class Mod implements IPostAkiLoadMod, IPostDBLoadMod 
{
    ...
    public postDBLoad(container: DependencyContainer): void 
    {
        ...
        const itemId = "MA_SNACCPACK",
        itemCategory = "5795f317245977243854e041",
        itemName = "Nutrition SICC",
        itemShortName = "SNACC", 
        itemPrefabPath = "snaccPack/snaccPack.bundle",
        itemDescription = "This SICC pouch is designated for food supplies. In other words, It's a certified SNACC pack!",
        itemTraderPrice = config.money_price,
        itemFleaPrice = config.money_price;
    ...
    allowInSecureContainers(itemId, items): void 
    {
